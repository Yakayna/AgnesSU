package com.agnessu.yakayn.data.settings
...
import com.agnessu.yakayn.domain.model.PlatformFeatureStatus
import com.agnessu.yakayn.domain.model.PlatformSetting
import com.agnessu.yakayn.domain.model.SettingsPlatformSnapshot
import com.agnessu.yakayn.magica.BootCompletedReceiver
...
class SettingsPlatformRepository(
    ...
    private fun toggleLauncherIcon(useAlt: Boolean) {
        ...
        val main = ComponentName(packageName, "com.agnessu.yakayn.ui.MainActivity")
        val alias = ComponentName(packageName, "com.agnessu.yakayn.ui.MainActivityAlias")
        application.packageManager.setComponentEnabledSetting(
