package com.agnessu.yakayn.ui.viewmodel
...
import com.agnessu.yakayn.ui.KsuService
import com.agnessu.yakayn.ui.util.HanziToPinyin
import com.agnessu.zako.IKsuInterface
...
enum class AppCategory(val displayNameRes: Int, val persistKey: String) {
    ALL(com.agnessu.yakayn.R.string.category_all_apps, "ALL"),
    ROOT(com.agnessu.yakayn.R.string.category_root_apps, "ROOT"),
    CUSTOM(com.agnessu.yakayn.R.string.category_custom_apps, "CUSTOM"),
    DEFAULT(com.agnessu.yakayn.R.string.category_default_apps, "DEFAULT");
...
enum class SortType(val displayNameRes: Int, val persistKey: String) {
    NAME_ASC(com.agnessu.yakayn.R.string.sort_name_asc, "NAME_ASC"),
    NAME_DESC(com.agnessu.yakayn.R.string.sort_name_desc, "NAME_DESC"),
    INSTALL_TIME_NEW(com.agnessu.yakayn.R.string.sort_install_time_new, "INSTALL_TIME_NEW"),
    INSTALL_TIME_OLD(com.agnessu.yakayn.R.string.sort_install_time_old, "INSTALL_TIME_OLD"),
    SIZE_DESC(com.agnessu.yakayn.R.string.sort_size_desc, "SIZE_DESC"),
    SIZE_ASC(com.agnessu.yakayn.R.string.sort_size_asc, "SIZE_ASC"),
    USAGE_FREQ(com.agnessu.yakayn.R.string.sort_usage_freq, "USAGE_FREQ");
